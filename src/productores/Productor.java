    ...
    public void run() {
        ...
        while (true) {
            ...
            if (Almacen.vacio) {
                ...
                /*System.out.println("vacio = " + Almacen.vacio);
                
                System.out.println("productores dentro del if ");
                System.out.println("almacenes disponibles [ " + almacen.disponibles + " ]");
                 */
                Almacen.estado = true;

                while (almacen.disponibles > 0) {  //mientras haya almacenes que no esten llenos
                        ...
                        synchronized (almacen) {
                            ...
                            if (almacen.estado == true) {
                                ...
                                if (!almacen.getEstado()) {
                                    System.out.println(" Todos los almacenes estan llenos  " + almacen.disponibles);
                                    Almacen.vacio = false;
                                }
                            }
